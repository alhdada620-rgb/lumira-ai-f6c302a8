...
export function HealthVitals() {
  ...
  return (
    <GlassPanel title={t("vitals.title")} icon={<Heart className="h-3.5 w-3.5" />}>
      <div className="space-y-4">
        <div className="rounded-lg border border-primary/15 bg-primary/5 p-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Heart className="h-4 w-4 fill-primary text-primary animate-pulse-glow" />
              <span className="text-xs uppercase tracking-widest text-muted-foreground">{t("vitals.heartRate")}</span>
            </div>
            <div className="flex items-baseline gap-1">
              <span className="text-2xl font-light text-glow">{bpm}</span>
              <span className="text-[10px] text-muted-foreground">{t("vitals.bpm")}</span>
            </div>
          </div>
          <Heartbeat />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-lg border border-primary/15 bg-card/40 p-3">
            ...
            <div className="text-[10px] uppercase tracking-widest text-muted-foreground">{t("vitals.sleep")}</div>
          ...
          <div className="rounded-lg border border-primary/15 bg-card/40 p-3">
            ...
            <div className="text-[10px] uppercase tracking-widest text-muted-foreground">{t("vitals.steps")}</div>
            <div className="mt-2 h-1 overflow-hidden rounded-full bg-muted">
